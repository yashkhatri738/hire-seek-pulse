...
import { ArrowLeft, CheckCircle, XCircle, Mail, MessageSquare, ExternalLink } from "lucide-react";
  ...
  return (
    <DashboardLayout role="employer" title={candidate.name}>
      <div className="max-w-2xl mx-auto">
        <Link href="/employer/candidates" className="inline-flex items-center gap-1 text-sm text-muted-foreground hover:text-foreground mb-4 transition-colors">
